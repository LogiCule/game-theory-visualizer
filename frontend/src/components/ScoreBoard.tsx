...
export default function ScoreBoard({ aliceScore, bobScore, showScore = true }: ScoreBoardProps) {
  return (
    <div className="flex justify-between items-center bg-hextech-panel/80 backdrop-blur-md p-4 md:p-6 rounded-none shadow-[0_4px_20px_rgba(0,0,0,0.5)] border border-hextech-border mb-8 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center">
        ...
        {showScore && <span className="text-3xl md:text-4xl font-black text-[#c89b3c] drop-shadow-[0_0_8px_rgba(200,155,60,0.5)]">{aliceScore}</span>}
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        {showScore && <span className="text-3xl md:text-4xl font-black text-[#0ac8b9] drop-shadow-[0_0_8px_rgba(10,200,185,0.5)]">{bobScore}</span>}
      </div>
    </div>
  );
}
